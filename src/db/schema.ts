...
export const bills = pgTable(
  "bills",
  {
    ...
    // When this bill was generated by repeating another, points to the original
    // (the "template"). The template itself has parent_bill_id = NULL.
  ...
  (t) => [
    ...
    index("bills_parent_idx").on(t.parentBillId),
  ]
);
